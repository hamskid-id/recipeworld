...
export const FollowSection = ()=>{
    return(
        <>
            <div className='p-5  text-white black'>
                <p className='fs-4 text-center text-white'>Follow Us On Social Media</p>

               <div id="carouselExampleControlsNoTouching" className="carousel slide mb-4" data-bs-touch="false" data-bs-interval="false">
                ...
                <div className='row justify-content-around'>
                    <div className='col-md-2'>
                        <p><a href='#' style={{textDecoration:'none'}} className='text-light'>
